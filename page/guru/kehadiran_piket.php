    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Kehadiran (Guru Piket)</h3>
        </div>
        <div class="box-body">
          <div class="row">
          <div class="col-md-12">
            <form class="form-inline" method="GET">
              <input type="hidden" name="page" value="kehadiran_piket">
              <div class="form-group">
                <select class="form-control js-data-example-ajax" name="kelas_id" onchange="showMapelByKelasOnly(this.value,'#mapel_id')" required>
            ...
            <?php endif;?>
            <hr>
            <form action="page/guru/kehadiran_piket_act.php" method="post">
