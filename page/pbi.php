...
<!-- Content Header (Page header) -->
    ...
    <section class="content">
                  ...
                  <div class="form-group">
                      <select name="id_kelas" id="" class="form-control" onchange="location = this.value;">
                        <option value="">Pilih Kelas</option>
                            ...
                            <option value="index.php?page=pbi&id_kelas=<?=$row['id_kelas']?>" <?=$_REQUEST['id_kelas'] == $row['id_kelas'] ? 'selected' : ''?> ><?=$row['kelas']?></option>
                            <?php endforeach; ?>
                      </select>
                  </div>
              </form>
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Dana PBI</h3>
        </div>
        <form action="page/pbi_act.php" method="POST">
        ...
        <div class="box-footer">
            ...
            <a href="index.php?page=pbi" class="btn btn-warning"><i class="fa fa-reply"></i> Batal</a>
        </div>
        </form>
      </div>
      <!-- /.box -->
