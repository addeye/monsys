...
<!-- Content Header (Page header) -->
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Perbaruhi Kenaikan Kelas</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Perbaruhi Kenaikan Kelas</h3>
        </div>
        <div class="box-body">
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    <form action="page/kenaikan_kelas_act.php?id=<?=$data['id']?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <select name="no_induk" class="form-control" required>
                                ...
                                <?php foreach ($sis as $row): ?>
                                    <option value="<?=$row['NO_INDUK']?>" <?=$data['no_induk'] == $row['NO_INDUK'] ? 'selected' : ''?> ><?=$row['NO_INDUK']?> <?=$row['NAMA']?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
