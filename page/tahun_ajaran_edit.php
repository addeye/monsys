        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    <form action="page/tahun_ajaran_act.php?id=<?=$data['id']?>" method="post">
                        <input type="hidden" name="aksi" value="edit">
                        <div class="form-group">
                            <label for="">Tahun Pelajaran</label>
                            <input type="text" name="nama" class="form-control" placeholder="Contoh : 2018/2019" value="<?=$data['nama']?>" required>
                        </div>
