...
<!--   <li class="treeview">
    ...
    <ul class="treeview-menu">
      <li><a href="index.php?page=set_iuran_spp"><i class="fa fa-circle-o"></i> Periode SPP</a></li>
      <li><a href="index.php?page=iuran_spp"><i class="fa fa-circle-o"></i> Iuran SPP</a></li>
      <li><a href="index.php?page=investasi"><i class="fa fa-circle-o"></i> Dana Investasi</a></li>
      <li><a href="index.php?page=pbi"><i class="fa fa-circle-o"></i> Dana PBI</a></li>
      <li><a href="index.php?page=asuransi"><i class="fa fa-circle-o"></i> Asuransi</a></li>
      <li><a href="index.php?page=peningkatan_mutu"><i class="fa fa-circle-o"></i> Peningkatan Mutu</a></li>
    </ul>
  </li>
  <li>
